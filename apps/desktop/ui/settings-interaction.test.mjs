...
test("Settings switches both ways, preserves optional notes, and shows a rejected change", async () => {
  ...
  let refuse = false;
  const engine = () => ({ selected, canChange: true, operationActive: false, apple: { state: "ready", locale: "en-US", reason: null } });
  ...
  const context = {
    ...
    window: { __TAURI__: { core: { invoke: async (command, args) => {
      ...
      if (command === "transcript_model_settings") return structuredClone(models);
